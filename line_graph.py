...
class LineGraphExample(Scene):
    def construct(self):
        ...
        all_graphs = VGroup()
        points = []
        measures = converters.parse_music_measures(graph_music_data.there_will_never_be_another_you)
        ...
        self.add(all_graphs)
        self.add(Tex("There Will Never Be Another You", color=BLACK).next_to(all_graphs, UP))
